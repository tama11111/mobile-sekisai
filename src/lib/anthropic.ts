...
【データベーステーブル】
- insurance_cases: 案件情報 (id, customer_id, vehicle_id, tow_status, tow_origin_address, tow_destination_address, distance_km, fare_amount, photos, signature_url, notes, created_at, updated_at)
  - tow_status: 'tow'=出動中, 'arrival'=現着, 'repair'=入庫, 'claim'=請求済
- insurance_details: 保険詳細 (id, case_id, insurer_name, policy_number, claim_number, adjuster_name, adjuster_phone, coverage_type)
- customers: 顧客 (id, name, phone, email, address)
